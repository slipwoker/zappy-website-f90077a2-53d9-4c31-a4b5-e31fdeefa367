        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('maxlength') && value !== '') {
                ...
                if (value.length > maxLength) {
                    showError(field, `Must be no more than ${maxLength} characters`);
                    return false;
                }
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f90077a2-53d9-4c31-a4b5-e31fdeefa367',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f90077a2-53d9-4c31-a4b5-e31fdeefa367';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f90077a2-53d9-4c31-a4b5-e31fdeefa367';
